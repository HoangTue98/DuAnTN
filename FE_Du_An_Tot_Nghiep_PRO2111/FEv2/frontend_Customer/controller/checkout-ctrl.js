app.controller('checkout-ctrl', function ($scope, $http, $routeParams, $rootScope) {
    ...
    const API_BILL_USER = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/bills';
    const API_USER = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/customer';
    const API_SETTING = 'http://buiquanghieu.xyz/PRO2111_FALL2022/admin/rest/settings/get-district-id-store';
    const API_VNPAY = 'http://buiquanghieu.xyz/PRO2111_FALL2022/api/vnpay/user'
