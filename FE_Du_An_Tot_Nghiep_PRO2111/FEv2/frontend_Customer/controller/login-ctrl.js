app.controller('login_controller', function ($scope, $http, $routeParams, $rootScope) {
  ...
  const apiLogin = `http://buiquanghieu.xyz/PRO2111_FALL2022/auth/user/login`;
  const apiCart = `http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/cart`;
  const API_REGISTER = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/customer';
  const API_RESET_OTP = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/customer/reset-otp';
  const API_CHECK_EMAIL = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/customer/check-email';
