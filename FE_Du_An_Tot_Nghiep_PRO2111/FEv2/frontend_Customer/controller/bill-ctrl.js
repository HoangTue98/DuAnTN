app.controller('bill-ctrl', function ($scope, $http, $routeParams, $rootScope) {
    ...
    const API_VARIANT_VALUE = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/variant-values';
    const API_BILL = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/bills/update'
    const API_PRODUCT = "http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/products";
    const API_IMAGE = 'http://buiquanghieu.xyz/PRO2111_FALL2022/admin/rest/image';
    const API_BILL_DETAIL = "http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/billdetails";
    const API_SETTING = 'http://buiquanghieu.xyz/PRO2111_FALL2022/admin/rest/settings/get-district-id-store';
    const API_OPTION = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/options';
    const API_OPTION_VALUE = "http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/option-values";
    const API_PRODUCT_VARIANT = 'http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/product-variants';
    const apiCartDetail = `http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/cartdetail`;
    const apiOptionValues = `http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/option-optionvalue`;
    const apiProductVariant = `http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/product-variants`;
    const apiProducts = `http://buiquanghieu.xyz/PRO2111_FALL2022/user/rest/products`;
