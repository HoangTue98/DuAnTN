app.controller('login_controller', function ($scope, $http, $routeParams, $rootScope) {
  ...
  const apiLogin = `http://localhost:8080/PRO2111_FALL2022/auth/user/login`;
  const apiCart = `http://localhost:8080/PRO2111_FALL2022/user/rest/cart`;
  const API_REGISTER = 'http://localhost:8080/PRO2111_FALL2022/user/rest/customer';
  const API_RESET_OTP = 'http://localhost:8080/PRO2111_FALL2022/user/rest/customer/reset-otp';
  const API_CHECK_EMAIL = 'http://localhost:8080/PRO2111_FALL2022/user/rest/customer/check-email';
  ...
  //  const api = `http://localhost:8080/PRO2111_FALL2022/PRO2111_FALL2022/auth/admin/login`;
