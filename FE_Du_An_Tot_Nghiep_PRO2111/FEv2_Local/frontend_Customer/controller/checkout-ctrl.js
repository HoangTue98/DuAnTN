app.controller('checkout-ctrl', function ($scope, $http, $routeParams, $rootScope) {
    ...
    const API_BILL_USER = 'http://localhost:8080/PRO2111_FALL2022/user/rest/bills';
    const API_USER = 'http://localhost:8080/PRO2111_FALL2022/user/rest/customer';
    const API_SETTING = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/settings/get-district-id-store';
    const API_VNPAY = 'http://localhost:8080/PRO2111_FALL2022/api/vnpay/user'
