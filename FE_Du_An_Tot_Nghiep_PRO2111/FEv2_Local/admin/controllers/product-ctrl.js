app.controller('product-ctrl', function ($scope, $http, $rootScope) {
    ...
    const productApi = "http://localhost:8080/PRO2111_FALL2022/admin/rest/products";
    const producOptiontApi = "http://localhost:8080/PRO2111_FALL2022/admin/rest/product-options";
    const optionValueAPI = "http://localhost:8080/PRO2111_FALL2022/admin/rest/option-values";
    const productVariantAPI = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/product-variants';
    const variantValueApi = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/variant-values'
    const imageApi = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/image';
    const API_OPTION = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/options';
    const API_QR_CODE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/genarate-QRCode';
    const API_DOWNLOAD_EXCEL = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/excel';
    const API_SEND_MAIL = 'http://buiquanghieu.xyz/TestSendMail/get-all-file/product';
    const productOptionApi = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/product-options';
    ...
    $scope.onEditVariantValue = function () {
        ...
        $http.put(`${variantValueApi}/update-status`, $scope.variantValue, {
            ...
            // $http.put(`http://localhost:8080/PRO2111_FALL2022/PRO2111_FALL2022/admin/rest/variant-values/update-status`, $scope.variantValue)
            .then(function (response) {
                $scope.isLoading = false;
    ...
    $scope.exportExcel = function () {
        ...
        //     headers: { 'Authorization': 'Bearer ' + $scope.authToken }
        // };
        // var url = ['http://localhost:8080/PRO2111_FALL2022/PRO2111_FALL2022/admin/rest/excel/export-template', $.param(params)].join('?');
        ...
        // $.ajax({
        //     type: 'GET',
        //     url: 'http://localhost:8080/PRO2111_FALL2022/PRO2111_FALL2022/admin/rest/excel/export-template',
        //     crossDomain: true,
