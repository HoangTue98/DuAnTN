app.controller('option-ctrl', function ($scope, $http) {
    ...
    const optionApi = "http://localhost:8080/PRO2111_FALL2022/admin/rest/options";

    const optionValuesApi = "http://localhost:8080/PRO2111_FALL2022/admin/rest/option-values";
