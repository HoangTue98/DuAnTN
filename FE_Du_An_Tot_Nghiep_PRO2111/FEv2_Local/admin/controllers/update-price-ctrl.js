app.controller('update-price-ctrl', function ($scope, $http) {
    ...
    const API_PRODUCT_VARIANT = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/update-price-product-variant';
    const API_VARIANT_VALUE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/variant-values';
    const API_UPDATE_PRICE = "http://localhost:8080/PRO2111_FALL2022/admin/rest/update-price-product-variant";
