app.controller('sale-ctrl', function ($scope, $http) {
    ...
    const API_SALE_UPDATE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/sales/saleparent-and-salechild';
    const API_VARIANT_VALUE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/variant-values';
    const API_PRODUCT = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/products';
    const API_SALE_CHILD_UPDATE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/sales/edit-sale_child';
    const API_SALE_CHILD_CREATE = 'http://localhost:8080/PRO2111_FALL2022/admin/rest/sales/create-sale-child';
