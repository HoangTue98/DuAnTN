...
app.controller("admin-ctrl", function ($scope, $http) {
    ...
    const API_LANGUAGE_NAV_ADMIN = 'http://localhost:8080/PRO2111_FALL2022/rest/language/nav/admin'
    const API_CHANGE_LANGUAGE = 'http://localhost:8080/PRO2111_FALL2022/rest-change-locale-admin'
    //Load laguage nav
